...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // defining the dynamic objects
    [params.data defineDynamicObject:@"DynamicObject1" type:ElastiCodeDObjType_string defaultValue:@"value1"];
    [params.data defineDynamicObject:@"DynamicObject2" type:ElastiCodeDObjType_arrayOfString defaultValue:@[@"value1",@"value2",@"value3"]];
